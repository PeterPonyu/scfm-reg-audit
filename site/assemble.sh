...
expected = [
    ("paper/submission_peerj/flat_upload/manuscript.pdf", "products/peerj-manuscript.pdf"),
...
if dest_peerj.stat().st_size != (root / "paper/submission_peerj/flat_upload/manuscript.pdf").stat().st_size:
