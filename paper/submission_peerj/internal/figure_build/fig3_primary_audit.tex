...
\end{scope}
\begin{scope}
\path[clip] (279.01, 41.82) rectangle (479.44,118.32);
\definecolor{fillColor}{RGB}{255,255,255}

\path[fill=fillColor] (279.01, 41.82) rectangle (479.44,118.32);
\definecolor{drawColor}{gray}{0.92}

\path[draw=drawColor,line width= 0.6pt,line join=round] (298.40, 41.82) --
	(298.40,118.32);

\path[draw=drawColor,line width= 0.6pt,line join=round] (330.73, 41.82) --
	(330.73,118.32);

\path[draw=drawColor,line width= 0.6pt,line join=round] (363.06, 41.82) --
	(363.06,118.32);

\path[draw=drawColor,line width= 0.6pt,line join=round] (395.38, 41.82) --
	(395.38,118.32);

\path[draw=drawColor,line width= 0.6pt,line join=round] (427.71, 41.82) --
	(427.71,118.32);

\path[draw=drawColor,line width= 0.6pt,line join=round] (460.04, 41.82) --
	(460.04,118.32);
\definecolor{fillColor}{RGB}{0,0,0}

\path[fill=fillColor] (299.21, 45.30) rectangle (310.53, 70.07);
\definecolor{fillColor}{RGB}{27,143,117}

\path[fill=fillColor] (286.28, 45.30) rectangle (297.59, 60.77);
\definecolor{fillColor}{RGB}{0,0,0}

\path[fill=fillColor] (428.52, 45.30) rectangle (439.84, 71.15);
\definecolor{fillColor}{RGB}{27,143,117}

\path[fill=fillColor] (415.59, 45.30) rectangle (426.90, 60.77);
\definecolor{fillColor}{RGB}{0,0,0}

\path[fill=fillColor] (363.87, 45.30) rectangle (375.18,114.84);
\definecolor{fillColor}{RGB}{27,143,117}

\path[fill=fillColor] (350.93, 45.30) rectangle (362.25, 60.77);
\definecolor{fillColor}{RGB}{0,0,0}

\path[fill=fillColor] (331.54, 45.30) rectangle (342.85, 69.14);
\definecolor{fillColor}{RGB}{27,143,117}

\path[fill=fillColor] (318.61, 45.30) rectangle (329.92, 84.39);
\definecolor{fillColor}{RGB}{0,0,0}

\path[fill=fillColor] (396.19, 45.30) rectangle (407.51,106.85);
\definecolor{fillColor}{RGB}{27,143,117}

\path[fill=fillColor] (383.26, 45.30) rectangle (394.58, 84.39);
\definecolor{fillColor}{RGB}{0,0,0}

\path[fill=fillColor] (460.85, 45.30) rectangle (472.16, 78.52);
\definecolor{fillColor}{RGB}{27,143,117}

\path[fill=fillColor] (447.92, 45.30) rectangle (459.23, 84.39);
\definecolor{drawColor}{gray}{0.20}

\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round] (279.01, 41.82) rectangle (479.44,118.32);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{gray}{0.30}

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.86] at (274.06, 42.10) {0.000};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.86] at (274.06, 64.52) {0.004};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.86] at (274.06, 86.94) {0.008};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.86] at (274.06,109.36) {0.012};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{gray}{0.20}

\path[draw=drawColor,line width= 0.6pt,line join=round] (276.26, 45.30) --
	(279.01, 45.30);

\path[draw=drawColor,line width= 0.6pt,line join=round] (276.26, 67.72) --
	(279.01, 67.72);

\path[draw=drawColor,line width= 0.6pt,line join=round] (276.26, 90.14) --
	(279.01, 90.14);

\path[draw=drawColor,line width= 0.6pt,line join=round] (276.26,112.56) --
	(279.01,112.56);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
...
\path[draw=drawColor,line width= 0.6pt,line join=round] (298.40, 39.07) --
	(298.40, 41.82);

\path[draw=drawColor,line width= 0.6pt,line join=round] (330.73, 39.07) --
	(330.73, 41.82);

\path[draw=drawColor,line width= 0.6pt,line join=round] (363.06, 39.07) --
	(363.06, 41.82);

\path[draw=drawColor,line width= 0.6pt,line join=round] (395.38, 39.07) --
	(395.38, 41.82);

\path[draw=drawColor,line width= 0.6pt,line join=round] (427.71, 39.07) --
	(427.71, 41.82);

\path[draw=drawColor,line width= 0.6pt,line join=round] (460.04, 39.07) --
	(460.04, 41.82);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
...
\node[text=drawColor,rotate= 40.00,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.68] at (301.65, 33.00) {GF emb-B};

\node[text=drawColor,rotate= 40.00,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.68] at (333.97, 33.00) {GF emb-P};

\node[text=drawColor,rotate= 40.00,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.68] at (366.30, 33.00) {scGPT-B};

\node[text=drawColor,rotate= 40.00,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.68] at (398.63, 33.00) {scGPT-P};

\node[text=drawColor,rotate= 40.00,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.68] at (430.96, 33.00) {UCE-B};

\node[text=drawColor,rotate= 40.00,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.68] at (463.28, 33.00) {UCE-P};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{RGB}{0,0,0}
...
\path[fill=fillColor] (391.30,103.61) rectangle (477.43,116.79);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{fillColor}{RGB}{255,255,255}

\path[fill=fillColor] (391.30,110.20) rectangle (398.53,116.79);
\definecolor{fillColor}{RGB}{27,143,117}

\path[fill=fillColor] (392.01,110.91) rectangle (397.82,116.08);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{fillColor}{RGB}{255,255,255}

\path[fill=fillColor] (391.30,103.61) rectangle (398.53,110.20);
\definecolor{fillColor}{RGB}{0,0,0}

\path[fill=fillColor] (392.01,104.32) rectangle (397.82,109.49);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.59] at (404.03,111.31) {co-expression baseline};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.59] at (404.03,104.71) {FM row};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (289.01,121.75) {Supported vs baseline};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{RGB}{0,0,0}
