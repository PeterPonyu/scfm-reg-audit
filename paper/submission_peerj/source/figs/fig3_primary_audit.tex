% Created by tikzDevice version 0.12.6 on 2026-08-16 23:27:45
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.00] at (142.87,321.73) {Non-degree sensitivity (both $q$ shown; no dual-null below 0.05)};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{RGB}{0,0,0}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (129.52,121.75) {Full-spec $q_M$ vs $q_D$ (13 rows)};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (491.44,578.16);
\definecolor{drawColor}{RGB}{0,0,0}
