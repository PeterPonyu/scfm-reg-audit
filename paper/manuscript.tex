...
usability check---their FM-versus-co-expression Spearman correlations are negative ($-0.02$ to
$-0.18$)---so their support is read as readout-specific geometry, not as regulatory recovery. The
