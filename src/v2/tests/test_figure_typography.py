...
class TestFigureMap:
    ...
    def test_all_composites_have_four_panels(self):
        """Test that all composites have exactly 4 panels (A, B, C, D)."""
        for comp in FIGURE_COMPOSITES.values():
            assert len(comp.panels) == 4
            assert comp.panels == ("A", "B", "C", "D")
